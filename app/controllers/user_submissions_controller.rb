class UserSubmissionsController < ApplicationController
  ...
  def new
    ...
    @possible_entities = GenericEntityMatcher.possible_matches(:title => @item.title, :entity_type => @user_submission.submission_details.entity_type) if @user_submission.submission_details.entity_type

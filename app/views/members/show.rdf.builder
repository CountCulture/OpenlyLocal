...
xml.tag! "rdf:RDF",
  ...
  xml.tag! "rdf:Description", "rdf:about" => member_url(:id => @member.id) do
    ...
    xml.tag! "dct:created", {"rdf:datatype" => "http://www.w3.org/2001/XMLSchema#dateTime"}, @member.created_at.xmlschema
    xml.tag! "dct:modified", {"rdf:datatype" => "http://www.w3.org/2001/XMLSchema#dateTime"}, @member.updated_at.xmlschema

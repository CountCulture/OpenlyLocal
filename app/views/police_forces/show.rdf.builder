...
xml.tag! "rdf:RDF",
  ...
  xml.tag! "rdf:Description", "rdf:about" => police_force_url(:id => @police_force.id) do
    ...
    xml.tag! "dct:created", {"rdf:datatype" => "http://www.w3.org/2001/XMLSchema#dateTime"}, @police_force.created_at.xmlschema
    xml.tag! "dct:modified", {"rdf:datatype" => "http://www.w3.org/2001/XMLSchema#dateTime"}, @police_force.updated_at.xmlschema
